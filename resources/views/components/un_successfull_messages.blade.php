...
<table class="table" id="un_successfull_messages">
  <thead>
    <tr>
      <th scope="col">No</th>
...
<script type="text/javascript">
  $(function () {
    ...
    var table = $('#un_successfull_messages').DataTable({
        processing: true,
        serverSide: true,
        "lengthChange": false,
        scrollX: true,
        dom:'lBfrtip',
        ajax: "{{ route('un_successfull_messages') }}",
        columns: [
            {data: 'DT_RowIndex', name: 'DT_RowIndex'},
            {data: 'message', name: 'message'},
            {data: 'contact', name: 'contact'},
            {data: 'status', name: 'status'},
            {data: 'responseText', name: 'responseText'},
        ...
        title: 'Unsuccessfull SMS Report',
